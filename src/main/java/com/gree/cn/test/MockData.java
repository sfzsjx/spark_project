package com.gree.cn.test;


import com.gree.cn.util.DateUtils;
import com.gree.cn.util.StringUtils;
...
public class MockData {
	...
	public static void mock(JavaSparkContext sc,
		...
		((Dataset) df).registerTempTable("user_visit_action");
		...
		Dataset<Row> dataFrame = sqlContext.createDataFrame(rowsRDD, schema2);
		final Dataset<Row> df2 = dataFrame;
