...
// 获取数据库的连接
            ...
            String sql = "insert into test_user(name,age) values('凤凰',20)";
    ...
    private static void update() {
        ...
        try {
            ...
            String sql = "update test_user set age=27 where name='凤凰'";
            int rtn = stmt.executeUpdate(sql);
    ...
    private static void delete() {
        ...
        try {
            ...
            String sql = "delete from test_user where name='凤凰'";
            int rtn = stmt.executeUpdate(sql);
